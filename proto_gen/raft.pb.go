...
type Log struct {
	...
	Index uint64 `protobuf:"varint,1,opt,name=index,proto3" json:"index,omitempty"` // Index of the log entry.
...
var file_raft_proto_rawDesc = []byte{
	...
	0x72, 0x61, 0x6e, 0x74, 0x65, 0x64, 0x2a, 0x2f, 0x0a, 0x04, 0x52, 0x6f, 0x6c, 0x65, 0x12, 0x0c,
	...
	,
...
var file_raft_proto_depIdxs = []int32{
	...
	3, // 3: konsen.Raft.AppendEntries:output_type -> konsen.AppendEntriesResp
	5, // 4: konsen.Raft.RequestVote:output_type -> konsen.RequestVoteResp
...
type RaftClient interface {
	...
	RequestVote(ctx context.Context, opts ...grpc.CallOption) (Raft_RequestVoteClient, error)
}
...
func (c *raftClient) AppendEntries(ctx context.Context, opts ...grpc.CallOption) (Raft_AppendEntriesClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Raft_serviceDesc.Streams[0], "/konsen.Raft/AppendEntries", opts...)
	if err != nil {
		return nil, err
	}
...
type Raft_AppendEntriesClient interface {
	Send(*AppendEntriesReq) error
	Recv() (*AppendEntriesResp, error)
	grpc.ClientStream
}
...
func (x *raftAppendEntriesClient) Send(m *AppendEntriesReq) error {
	return x.ClientStream.SendMsg(m)
}

func (x *raftAppendEntriesClient) Recv() (*AppendEntriesResp, error) {
	m := new(AppendEntriesResp)
...
func (c *raftClient) RequestVote(ctx context.Context, opts ...grpc.CallOption) (Raft_RequestVoteClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Raft_serviceDesc.Streams[1], "/konsen.Raft/RequestVote", opts...)
	if err != nil {
		return nil, err
	}
	x := &raftRequestVoteClient{stream}
	return x, nil
}

type Raft_RequestVoteClient interface {
	Send(*RequestVoteReq) error
	Recv() (*RequestVoteResp, error)
	grpc.ClientStream
}

type raftRequestVoteClient struct {
	grpc.ClientStream
}

func (x *raftRequestVoteClient) Send(m *RequestVoteReq) error {
	return x.ClientStream.SendMsg(m)
}

func (x *raftRequestVoteClient) Recv() (*RequestVoteResp, error) {
	m := new(RequestVoteResp)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type RaftServer interface {
	...
	// Sends "RequestVote" request.
	RequestVote(Raft_RequestVoteServer) error
}
...
func (*UnimplementedRaftServer) RequestVote(Raft_RequestVoteServer) error {
...
type Raft_AppendEntriesServer interface {
	Send(*AppendEntriesResp) error
	Recv() (*AppendEntriesReq, error)
	grpc.ServerStream
}
...
func (x *raftAppendEntriesServer) Send(m *AppendEntriesResp) error {
	return x.ServerStream.SendMsg(m)
}

func (x *raftAppendEntriesServer) Recv() (*AppendEntriesReq, error) {
	m := new(AppendEntriesReq)
...
func _Raft_RequestVote_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(RaftServer).RequestVote(&raftRequestVoteServer{stream})
}

type Raft_RequestVoteServer interface {
	Send(*RequestVoteResp) error
	Recv() (*RequestVoteReq, error)
	grpc.ServerStream
}

type raftRequestVoteServer struct {
	grpc.ServerStream
}

func (x *raftRequestVoteServer) Send(m *RequestVoteResp) error {
	return x.ServerStream.SendMsg(m)
}

func (x *raftRequestVoteServer) Recv() (*RequestVoteReq, error) {
	m := new(RequestVoteReq)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
