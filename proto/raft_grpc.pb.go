...
const (
	...
	Raft_InstallSnapshot_FullMethodName = "/konsen.Raft/InstallSnapshot"
)
...
type RaftClient interface {
	...
	// Sends "InstallSnapshot" request (Raft paper Section 7, Figure 13).
...
func (c *raftClient) InstallSnapshot(ctx context.Context, in *InstallSnapshotReq, opts ...grpc.CallOption) (*InstallSnapshotResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedRaftServer) InstallSnapshot(context.Context, *InstallSnapshotReq) (*InstallSnapshotResp, error) {
