...
type InstallSnapshotReq struct {
	...
	LastIncludedIndex uint64                 `protobuf:"varint,3,opt,name=last_included_index,json=lastIncludedIndex,proto3" json:"last_included_index,omitempty"` // The snapshot replaces all entries up through and including this index.
	LastIncludedTerm  uint64                 `protobuf:"varint,4,opt,name=last_included_term,json=lastIncludedTerm,proto3" json:"last_included_term,omitempty"`    // Term of lastIncludedIndex entry.
...
const file_proto_raft_proto_rawDesc = "" +
	"\n" +
	"\x10proto/raft.proto\x12\x06konsen\"C\n" +
	"\x03Log\x12\x14\n" +
	...
	"\n" +
	"\x06LEADER\x10\x022\xde\x01\n" +
	"\x04Raft\x12F\n" +
	"\rAppendEntries\x12\x18.konsen.AppendEntriesReq\x1a\x19.konsen.AppendEntriesResp\"\x00\x12@\n" +
	"\vRequestVote\x12\x16.konsen.RequestVoteReq\x1a\x17.konsen.RequestVoteResp\"\x00\x12L\n" +
	"\x0fInstallSnapshot\x12\x1a.konsen.InstallSnapshotReq\x1a\x1b.konsen.InstallSnapshotResp\"\x00B\vZ\t./;konsenb\x06proto3"
...
var file_proto_raft_proto_goTypes = []any{
	...
	(*InstallSnapshotReq)(nil),  // 6: konsen.InstallSnapshotReq
	(*InstallSnapshotResp)(nil), // 7: konsen.InstallSnapshotResp
}
var file_proto_raft_proto_depIdxs = []int32{
	...
	6, // 3: konsen.Raft.InstallSnapshot:input_type -> konsen.InstallSnapshotReq
	...
	7, // 6: konsen.Raft.InstallSnapshot:output_type -> konsen.InstallSnapshotResp
